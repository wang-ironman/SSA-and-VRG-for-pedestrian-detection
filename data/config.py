...
home = os.path.expanduser("G:/project/pytorch-ssd-ad/")
...
v = {
    ...
    '[640, 480]': {
        ...
        'feature_maps': [[60,80], [30,40], [15,20], [8,10], [6,8], [4,6]],  # 提框的feature maps

        'min_dim': [640,480],    # w,h

        'steps': [[8,8], [16,16], [32,32], [60,64], [80,80], [120,106]],   # 倍数要对齐, w对应w， h对应h
