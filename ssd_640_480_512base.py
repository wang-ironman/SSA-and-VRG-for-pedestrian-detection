...
class SSD(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, head, num_classes):
        ...
        if self.phase == 'test':
            ...
            self.detect = Detect(num_classes, self.size, 0, 200, 0.001, 0.45)
    ...
    def forward(self, x):
        ...
        for (x, l, c) in zip(sources, self.loc, self.conf):
            ...
            # print(c(x).permute(0, 2, 3, 1).contiguous().shape)
...
extras = {
    ...
    '512': [256, 'S', 512, 128, 'S', 256, 128, 256, 128, 256, 128],
}
mbox = {
...
def build_ssd(phase, size=[640,480], num_classes=2):
    ...
    return SSD(phase, size, *multibox(vgg(base['512'], 3),
                                ...
                                mbox['512'], num_classes), num_classes)
